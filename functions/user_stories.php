...
<head>
    ...
    <title><?= htmlspecialchars($username) ?>'s Stories</title>
    <style>
        body {
...
<body>
    ...
    <div class="stories-container">
        <h1 style="margin-bottom: 20px; color: #fff; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);"><strong>My Today Stories</strong></h1>
